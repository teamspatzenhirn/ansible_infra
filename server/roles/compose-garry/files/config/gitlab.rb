...
external_url 'https://git.spatz.wtf'
...
gitlab_rails['omniauth_providers'] = [
  {
    name: "openid_connect",
    label: "Spatz IDM",
    icon: "https://idm.spatz.wtf/ui/images/domain",
    args: {
      name: "openid_connect",
      scope: ["openid", "profile", "email"],
      response_type: "code",
      issuer: "https://idm.spatz.wtf/oauth2/openid/gitlab",
      discovery: true,
      ...
      client_options: {
        identifier: "gitlab",
        secret: ENV['KANIDM_GITLAB_OAUTH_SECRET'],
        redirect_uri: "https://git.spatz.wtf/users/auth/openid_connect/callback"
      }
    }
  }
]
...
registry_external_url 'https://git.spatz.wtf:5050'
...
gitlab_rails['registry_enabled'] = true
gitlab_rails['registry_host'] = "git.spatz.wtf"
...
pages_external_url "http://pages.spatz.wtf/"
